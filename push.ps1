...
if ($Branch -ne "HEAD")
{
    Invoke-DotNet nuget push ./publish/PackageLib/*.nupkg --source github --skip-duplicate
    ...
    if ($Branch -in $pushBranches)
    {
        ...
        {
            Invoke-DotNet nuget push ./publish/PackageLib/*.nupkg --source nuget --api-key $NUGETTOKEN
        }
    }
}